...
// Returns queue id
func (j *Jenkins) BuildJob(ctx context.Context, name string, params map[string]string, cParam map[string][]string) (int64, error) {
	job := j.GetJobObj(ctx, name)
	return job.InvokeSimple(ctx, params, cParam)
}
